...
public class Ask {
     ...
     * @param price
     */
    public Ask(long price, long quantity) {
        super();
        this.price = price;
    ...
    public Ask withPrice(long price) {
        this.price = price;
        return this;
    }
    ...
    public Ask withQuantity(long quantity) {
        this.quantity = quantity;
        return this;
    }
    ...
    public Ask withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
